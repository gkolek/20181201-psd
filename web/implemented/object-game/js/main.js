var game = {
    ...
    moveDown: function () {
        if (this.hp > 0) {
            this.car.y = Math.min(600 - this.car.height, this.car.y + 15);
            this.car.updatePosition();
            this.calculateCollides();
        }
    },
    moveRight: function () {
        if (this.hp > 0) {
            this.car.x = Math.min(600 - this.car.width, this.car.x + 15);
            this.car.updatePosition();
            this.calculateCollides();
        }
    },
    generateCar: function () {
        this.car = {
            ...
            collide: function (object) {
                // Zakładamy ze car musi najechac na srodek obiektu
    ...
    generateBomb: function () {
        ...
        var bomb = {
            ...
            drawBomb: function () {
                ...
                this.x = Math.max(0, Math.random() * 600 - this.width);
                this.y = Math.max(0, Math.random() * 600 - this.height);
                this.updatePosition();
            },
